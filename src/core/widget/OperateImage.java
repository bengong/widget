...
public class OperateImage {
	...
	public static void main(String[] args) throws Exception {
		...
		String name = "D:/dev/Colotec5/images/nav_spr.png";
		...
		for(int i = 0; i < count; i++) {
			...
			o.setSubpath("D:/dev/Colotec5/images/"+(i+1)+".png ");
			o.cut();
		}
		
//		String name = "D:/dev/Colotec5/images/index_icons.png";
//		int count = 8;
//		for(int i = 0; i < count; i++) {
//			int x = (i%2)*48;
//			int y = (i/2)*48;
...
//			o.setSrcpath(name);
//			
//			o.setSubpath("D:/dev/Colotec5/images/p_"+(i+1)+".png ");
//			o.cut();
//		}
	}
}